...
abstract class C_Controller
{
  ...
  protected function is_logged() {
    return !empty($this->getLogin());
  }

  protected function is_Admin() {
    return $_SESSION['Admin'];
  }
  protected function getTitlesHistory() {
    return $_SESSION['titles'];
  }

  protected function pushTitleToHistory($title) {
    if (empty($_SESSION['titles'])) $_SESSION['titles'] = [];
